...
def main():
    ...
    # parser.add_argument('--plot_power_residual', action='store_true', help='Generate and save a figure of the P1D fit residual (default: False)')
